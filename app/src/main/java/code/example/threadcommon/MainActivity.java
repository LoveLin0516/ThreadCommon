...
//                            public String execute() {
//                                String test = "test";
//                                test = test + "_lalala222";
//
//                                Log.d("ansen", "thread-name-4--->" + Thread.currentThread().getName());
//                                Log.d("ansen", "thread-id-4--->" + Thread.currentThread().getId());
//
//                                return test;
//                            }
//                        }, new AppExecutors.OnUICallBack<String>() {
//                            @Override
//                            public void invoke(String s) {
//                                Log.d("ansen", "result--2->" + s);
//                                Log.d("ansen", "thread-name-5--->" + Thread.currentThread().getName());
//                                Log.d("ansen", "thread-id-5--->" + Thread.currentThread().getId());
//                            }
//                        });
//            }
//        }, 2000L);
